defmodule FiostatsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FiostatsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FiostatsWeb.Gettext, "errors", msg, opts)
    end
  end
